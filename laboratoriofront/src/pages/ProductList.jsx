    ...
    return (
        <div className="container mx-auto p-4 md:p-8 bg-gray-100 min-h-screen">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <h1 className="text-4xl font-extrabold text-gray-800 mb-4 md:mb-0">Productos</h1>
                <Link
                    to="/products/create"
                        ...
                        {products.map((product) => (
                            <tr key={product.id} className="hover:bg-gray-50 transition duration-200">
                                <td className="px-6 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div className="text-gray-900 whitespace-no-wrap">{product.name}</div>
                                </td>
                                <td className="px-6 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div className="text-gray-900 whitespace-no-wrap">{product.description}</div>
                                </td>
                                <td className="px-6 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div className="text-gray-900 whitespace-no-wrap">${product.price.toFixed(2)}</div>
                                </td>
                                <td className="px-6 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div className="text-gray-900 whitespace-no-wrap">{product.stockQuantity}</div>
                                </td>
                                <td className="px-6 py-5 border-b border-gray-200 bg-white text-sm">
                                    <Link
